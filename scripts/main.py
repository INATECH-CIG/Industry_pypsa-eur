...
#                   2. "industry_only", 
#                   3. "esm_softlinked"
# in that order since results from previous optimizations 
# are needed for the next optimization
###########################################################
coupling = "coupled"

###################################################
# parameters for base scenario
###################################################
...
name = f"{coupling}_Mat_{mat_scenario}_H2_{H2_importcost}"
if coupling == "esm_only":
    name = f"esm_only_H2_{H2_importcost}"
...
if coupling == "esm_softlinked":
    ...
    namei = f"solved_industry_only_Mat_{mat_scenario}_H2_{H2_importcost}.nc"
